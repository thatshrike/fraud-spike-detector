...
from anomaly_detection import detect_anomalies_zscore, detect_anomalies_isolationforest, evaluate_predictions, detect_anomalies_ensemble
...
def main():
    ...
    print(f"{'Ensemble':<15} | {format_metric(e_metrics['p']):<25} | {format_metric(e_metrics['r']):<25} | {format_metric(e_metrics['f']):<25}")
    print("="*80)
